...
def is_actionable(tagged_sent):
    if tagged_sent[-1][0] != "?":
        ...
        if pls or (tagged_sent[0][1] == "VB" or tagged_sent[0][1] == "MD" or tagged_sent[0][1] == "WP" or tagged_sent[0][1] == "JJ" or tagged_sent[0][1] == "VBG" or tagged_sent[0][1] == "NN" or tagged_sent[0][1] == "WRB"):
            return True
...
def getoutlook():
  ...
  #print("check ", inbox.get_messages())
  for message in inbox.get_messages(limit=2):
